...
const PHONE_SMS_PATTERNS = [
  ...
  { label: 'phone verification page state', pattern: /phone_verification_page/ },
  { label: 'phone auth route slug', pattern: /add-phone|phone-verification/ },
  { label: 'phone verification allow flag', pattern: /allowPhoneVerificationPage/ },
  ...
  { label: 'phone identity equality branch', pattern: /\baccountIdentifierType\b\s*={2,3}\s*['"]phone['"]/ },
